...
<body>
        ...
        <section class="experiment recordrtc">
            <h2 class="header">
                <select class="recording-media" style="border:3 #178BDD solid;border-radius:5px;">
                    <option value="record-video">Video</option>
                    <option value="record-audio">Audio</option>
                    <option value="record-screen">Screen</option>
                </select> into
                <select class="media-container-format" style="border:3 #178BDD solid;border-radius:5px;">
                    <option>WebM</option>
                    <option >Mp4</option>
                </select>
            ...
            <div style="text-align: center; display: none;" style="border:3 #178BDD solid;border-radius:5px;">
                <button id="save-to-disk" class="btn btn-success">Save To Disk</button>
                <button id="open-new-tab" class="btn btn-warning">Open New Tab</button>
                <button id="upload-to-server" class="btn btn-primary">Upload To Server</button>
            </div>
